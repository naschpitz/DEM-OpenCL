...
FaceCL Face::getCL(uint index, uint materialIndex) const
{
  ...
  faceCL.currentPosition = {this->currentPosition.getX(), this->currentPosition.getY(), this->currentPosition.getZ(),
                            0};

  faceCL.currentVelocity = {this->currentVelocity.getX(), this->currentVelocity.getY(), this->currentVelocity.getZ(),
                            0};
