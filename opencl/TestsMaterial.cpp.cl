...
kernel void test_material_calculateForce(
    global const Material* materials,
    float4 distance,
    float4 distanceUnitary,
    int internal,
    float contactArea,
...
{
    output[0] = material_calculateForce(&materials[0], distance, distanceUnitary, (bool)internal, contactArea, originalLength, oldForce);
}

kernel void test_material_calculateDragForce(
    global const Material* materials,
    float4 velocity,
