...
void face_calculateCurrentPosition(Face* face)
{
  face->currentPosition =
    (face->vertexes[0].currentPosition + face->vertexes[1].currentPosition + face->vertexes[2].currentPosition) / 3;
}

void face_calculateCurrentVelocity(Face* face)
{
  face->currentVelocity =
    (face->vertexes[0].currentVelocity + face->vertexes[1].currentVelocity + face->vertexes[2].currentVelocity) / 3;
}

void face_calculateMeanVelocity(Face* face)
{
  face->meanVelocity =
    (face->vertexes[0].meanVelocity + face->vertexes[1].meanVelocity + face->vertexes[2].meanVelocity) / 3;
}
