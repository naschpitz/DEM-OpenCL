...
kernel void test_object_to_particle(global Face* faces, const uint numFaces, global Particle* particles, global float4* outputFace, global float4* outputParticle)
{
