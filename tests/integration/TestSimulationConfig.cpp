...
void TestSimulationConfig::missingRequiredFields()
{
  ...
  for (const Case& c : cases) {
    ...
    try {
      ...
      QVERIFY2(QString(e.what()) == QString::fromStdString(c.message), QString("Field '%1': expected '%2' but got '%3'")
                                                                         .arg(QString::fromStdString(c.field))
...
void TestSimulationConfig::stateMachine()
{
  ...
  QVERIFY2(simulation.isRunning(), "Freshly constructed Simulation should report isRunning()=true");
