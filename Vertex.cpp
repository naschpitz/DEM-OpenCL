...
VertexCL Vertex::getCL() const
{
  ...
  vertexCL.currentPosition = {this->currentPosition.getX(), this->currentPosition.getY(), this->currentPosition.getZ(),
                              0};
  vertexCL.oldPosition = {this->oldPosition.getX(), this->oldPosition.getY(), this->oldPosition.getZ(), 0};
  vertexCL.originalPosition = {this->originalPosition.getX(), this->originalPosition.getY(),
                               this->originalPosition.getZ(), 0};

  vertexCL.currentVelocity = {this->currentVelocity.getX(), this->currentVelocity.getY(), this->currentVelocity.getZ(),
                              0};
  ...
  vertexCL.originalVelocity = {this->originalVelocity.getX(), this->originalVelocity.getY(),
                               this->originalVelocity.getZ(), 0};

  vertexCL.currentAngularVelocity = {this->currentAngularVelocity.getX(), this->currentAngularVelocity.getY(),
                                     this->currentAngularVelocity.getZ(), 0};
  vertexCL.meanAngularVelocity = {this->meanAngularVelocity.getX(), this->meanAngularVelocity.getY(),
                                  this->meanAngularVelocity.getZ(), 0};
  vertexCL.oldAngularVelocity = {this->oldAngularVelocity.getX(), this->oldAngularVelocity.getY(),
                                 this->oldAngularVelocity.getZ(), 0};
...
void Vertex::setCL(const VertexCL& vertexCL)
{
  ...
  this->originalPosition =
    Vector3D(vertexCL.originalPosition.x, vertexCL.originalPosition.y, vertexCL.originalPosition.z);
  ...
  this->originalVelocity =
    Vector3D(vertexCL.originalVelocity.x, vertexCL.originalVelocity.y, vertexCL.originalVelocity.z);

  this->currentAngularVelocity =
    Vector3D(vertexCL.currentAngularVelocity.x, vertexCL.currentAngularVelocity.y, vertexCL.currentAngularVelocity.z);
  this->meanAngularVelocity =
    Vector3D(vertexCL.meanAngularVelocity.x, vertexCL.meanAngularVelocity.y, vertexCL.meanAngularVelocity.z);
  this->oldAngularVelocity =
    Vector3D(vertexCL.oldAngularVelocity.x, vertexCL.oldAngularVelocity.y, vertexCL.oldAngularVelocity.z);
}
